...
const getConversationURL = (username, receiver) => (SERVER_URL + username + '/' + receiver);
...
export const getConversation = (username, receiver, setConversation) => {
  makeRequest('GET', getConversationURL(username, receiver), setConversation, 'conversation');
};
...
export const sendMessage = (username, receiver, message) => {
  if (message) {
    ...
    makeRequest('POST', getConversationURL(username, receiver), () => (null), null, message);
  }
};
